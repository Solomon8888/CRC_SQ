...
#    results/ngs/GSE299428/tables/<analysis_name>/DEG/significant_genes.csv
# 2. 02号脚本生成的每套交集基因列表：
#    results/ngs/GSE299428/intersect/<intersection_scheme>/gene_list.csv
#
# 注意：
...
#
# 输出：
# results/ngs/GSE299428/TF/DEG/<analysis_name>/<method>/
# results/ngs/GSE299428/TF/intersect/<intersection_scheme>/<method>/
